    ...
    <div className="min-h-screen bg-[#f5f5f5] pb-28 max-w-lg mx-auto">
      ...
      <div className="bg-white mt-2 px-4 py-4 space-y-3">
        ...
        <input
          ...
          onBlur={() => lookupCep(customer.zip)}
          autoComplete="postal-code"
          inputMode="numeric"
          className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-[14px]"
        />
        {cepLoading && <p className="text-[12px] text-gray-500">Buscando endereço...</p>}
        {cepError && <p className="text-[12px] text-red-600">{cepError}</p>}
        <input
          placeholder="Rua"
        ...
        <div className="grid grid-cols-2 gap-2">
          <input
            ...
            onChange={(e) => setCustomer({ number: maskNumber(e.target.value) })}
            autoComplete="off"
            inputMode="numeric"
        ...
        <div className="grid grid-cols-3 gap-2">
          ...
          <input
            ...
            onChange={(e) => setCustomer({ state: e.target.value.toUpperCase().replace(/[^A-Z]/g, '').slice(0, 2) })}
            autoComplete="address-level1"
            className="border border-gray-200 rounded-lg px-3 py-2.5 text-[14px] uppercase"
          />
        </div>
      ...
      <div className="bg-white mt-2 px-4 py-4">
        <h2 className="text-[15px] font-bold mb-3">Oferta exclusiva 🔥</h2>
        <label
